...
<body>
    ...
    <div class="test-section">
        ...
        echo "<li>Current action: " . current_action() . "</li>";
        echo "<li>Current filter: " . current_filter() . "</li>";
        ...
        if (class_exists('Searchcraft_Admin')) {
            ...
            echo "<li>Init hooks registered: " . $init_hooks . "</li>";
        ...
        foreach ($debug_log_paths as $log_path) {
            if ($log_path && file_exists($log_path)) {
                ...
                if ($lines) {
                    ...
                    $searchcraft_lines = array_filter($recent_lines, function($line) {
    ...
    <div class="test-section">
        ...
        if (class_exists('Searchcraft_SDK_Integration')) {
            ...
            if (!empty($js_config)) {
                ...
                echo "<pre>" . esc_html(json_encode($js_config, JSON_PRETTY_PRINT)) . "</pre>";
