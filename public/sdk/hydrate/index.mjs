...
class SearchcraftInputLabel$1 {
    ...
    label = '';
    render() {
        return (hAsync("label", { key: '3622c616d480e57b1dfaa2d61637a30b843cb968', class: classNames('searchcraft-input-label', this.inputLabelClassName), htmlFor: 'searchcraft-input-id' }, this.label));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftInputLabel {
    ...
    label;
    render() {
        return (hAsync("div", { key: '507cde7e8f74682d0535a65fbc787b18fa4c49f7', class: 'searchcraft-loading' }, hAsync("div", { key: 'de8d4db44bd0d54baa276403063327b040a39ee4', class: 'searchcraft-loading-bars' }, hAsync("div", { key: '3ef1ad066aef5582de0afe08c598747e48533f0a', class: 'searchcraft-loading-bar-1' }), hAsync("div", { key: '0e9b5bfb8c031b1d788b0f39a63b1b325f123aad', class: 'searchcraft-loading-bar-2' }), hAsync("div", { key: 'b342f47a3869301d17e66f0ae79cbea6b2a7ed41', class: 'searchcraft-loading-bar-3' }), hAsync("div", { key: 'c11c58254a005b80c54b98f6713acb4c7f376a58', class: 'searchcraft-loading-bar-4' }), hAsync("div", { key: 'c53ff4d003ed8e1d17fdc2ab8d61b2d3313dd5ac', class: 'searchcraft-loading-bar-5' }), hAsync("div", { key: '3f517f20a24a844c04562cbb95b3a39502905405', class: 'searchcraft-loading-bar-6' })), hAsync("p", { key: '11a63145472d8ded9d28bf7e9cfde9097e6a02e2', class: 'searchcraft-loading-label' }, this.label)));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
...
class SearchcraftPopoverButton {
    ...
    render() {
        return (hAsync("button", { key: 'ef815c1ea4ecde68fe152f80b811a95ccb9a38be', class: `searchcraft-popover-button ${this.type ? ` searchcraft-popover-button-${this.type}` : ''}`, innerHTML: typeof this.template !== 'undefined'
...
class SearchcraftPopoverListItem {
    ...
    render() {
        return (hAsync("div", { key: 'fe1f0a2803c05c7f7901a1e34e3751283683b841', class: 'searchcraft-popover-list-item' }, hAsync("a", { key: 'b1765b28e4df4483554e4aa1e776f85817f45709', class: 'searchcraft-popover-list-item-link', href: this.href, onClick: this.handleLinkClick.bind(this) }, this.imageSource && (hAsync("div", { key: 'd47112466fe3414278f88db73294c829eceb63ba', class: 'searchcraft-popover-list-item-image-wrapper' }, hAsync("img", { key: 'cf65d6520a2586f9b056775a0d1c3e85cb81cdd7', alt: this.imageAlt, src: this.imageSource, class: 'searchcraft-popover-list-item-image' }))), hAsync("div", { key: 'b6bdaf2e52e216d20c23790b4b53563be8709d40', class: 'searchcraft-popover-list-item-content' }, this.title && (hAsync("p", { key: '21a6541924914c8ea2b798d0e910c6e4544b7e46', class: 'searchcraft-popover-list-item-content-title' }, this.title)), this.subtitle && (hAsync("p", { key: '625a1d6b1a7e6bfb848fd49cb316968b396b0473', class: 'searchcraft-popover-list-item-content-subtitle' }, this.subtitle))))));
    }
    static get cmpMeta() { return {
        "$flags$": 0,
