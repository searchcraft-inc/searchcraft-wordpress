...
import { d as defineCustomElement$3 } from './searchcraft-button2.js?scv=0.15.0';
import { d as defineCustomElement$2 } from './searchcraft-error-message2.js?scv=0.15.0';
import { d as defineCustomElement$1 } from './searchcraft-input-label2.js?scv=0.15.0';
    ...
    components.forEach(tagName => { switch (tagName) {
        case "searchcraft-input-form":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), SearchcraftInputForm);
            }
            break;
...
//# sourceMappingURL=searchcraft-input-form2.js.map
