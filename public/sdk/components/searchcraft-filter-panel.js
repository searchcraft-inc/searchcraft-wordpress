...
import { d as defineCustomElement$4 } from './searchcraft-facet-list2.js?scv=0.15.1';
import { d as defineCustomElement$3 } from './searchcraft-slider2.js?scv=0.15.1';
import { d as defineCustomElement$2 } from './searchcraft-toggle-button2.js?scv=0.15.1';
            ...
            switch (filterItem.type) {
                ...
                case 'facets': {
                    ...
                    return (h("div", { class: 'searchcraft-filter-panel-section' }, h("p", { ref: (el) => {
                        ...
                        role: 'button', tabIndex: 0 }, filterItem.label), h("searchcraft-facet-list", { ref: (el) => {
    ...
    components.forEach(tagName => { switch (tagName) {
        case "searchcraft-filter-panel":
            if (!customElements.get(transformTag(tagName))) {
                customElements.define(transformTag(tagName), SearchcraftFilterPanel$1);
            }
            break;
